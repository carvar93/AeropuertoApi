...
namespace AccesoDatos
{
    public class Acceso_Perfil
    {
        ...
        /// <summary>
        /// Método para agregar una Perfil_Usuario en la colección de mongoDb
        /// </summary>
        /// <param name="P_entidad">Entidad de tipo Perfil_Usuario</param>
        /// <returns>TRUE = Correcto</returns>
        public bool AgregarPerfil(Perfil_Usuario entidad)
        {
            try
            {
                GetConexion(NombreBD);
                var coleccion = basedatos.GetCollection<Perfil_Usuario>("Perfil");
        ...
        /// <param name="P_entidad">Entidad de tipo Perfil_Usuario</param>
        /// <returns>TRUE = Correcto</returns>
        public bool ModificarPerfil_Usuario(Perfil_Usuario entidad)
        {
            try
            {
                GetConexion(NombreBD);
        ...
        /// <param name="P_entidad">Entidad de tipo Perfil_Usuario</param>
        /// <returns>TRUE = Correcto</returns>
        public bool EliminarPerfil_Usuario(Perfil_Usuario Pe_entidad)
        {
            try
            {
                GetConexion(NombreBD);
                ...
                coleccion.DeleteOne(d => d._id == Pe_entidad._id);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// <summary>
        /// Método de consulta de los registros de Perfil_Usuario
        /// </summary>
        /// <param name="P_entidad">Entidad de tipo Perfil_Usuario, por defecto puede ir NULL</param>
        /// <returns>Entidad de tipo Lista Perfil_Usuario</returns>
        public List<Perfil_Usuario> ListarPerfil_Usuario(Perfil_Usuario Pe_entidad = null)
        {
            List<Perfil_Usuario> lstresultado = new List<Perfil_Usuario>();
